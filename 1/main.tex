...
\begin{columns}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=\linewidth]{Img/kernelUserSpace.jpg}
	\end{figure}
...
\begin{frame}[t]{Kernel modules}
		\textbf{Kernel Modules}
		\begin{itemize}
			\item Statically build
...
\begin{frame}[t]{User Space}
	...
	\vspace{2cm}
	Examples, ls, cd, chmod, wm, de...
\end{frame}

\begin{frame}[t]{User Space}{strace example}
